...
from services.binance.models import OrderStatusResponse, OcoOrderResponse
...
async def process_cancel_open_orders_response(response: Dict[str, Any]) -> Optional[List[Union[OrderStatusResponse, Dict[str, Any]]]]:
    """
