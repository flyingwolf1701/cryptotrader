...
async def getOrderHistoryWS(
    ...
    msg_id = await connection.send(
        method="allOrders", params=params, security_type=SecurityType.USER_DATA
    )
...
async def process_order_history_response(
    response: Dict[str, Any],
) -> Optional[List[OrderStatusResponse]]:
    """
