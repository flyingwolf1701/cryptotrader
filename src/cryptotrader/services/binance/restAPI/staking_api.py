...
from cryptotrader.services.binance.models.staking_models import (
    StakingAssetInfo, StakingOperationResult, StakingStakeResult, 
    StakingUnstakeResult, StakingBalanceResponse, StakingHistoryItem,
...
class StakingOperations:
    ...
    def get_staking_asset_info(self, staking_asset: Optional[str] = None) -> List[StakingAssetInfo]:
        """
        ...
        """
        request = self.request("GET", "/sapi/v1/staking/asset", RateLimitType.REQUEST_WEIGHT, 1) \
            .requires_auth(True)
        ...
        if response:
            for asset_data in response:
                asset_info_list.append(StakingAssetInfo.from_api_response(asset_data))
        
        return asset_info_list
    
    def stake(self, staking_asset: str, amount: Union[str, float], 
             auto_restake: Optional[bool] = True) -> Optional[StakingStakeResult]:
        """
        ...
        """
        request = self.request("POST", "/sapi/v1/staking/stake", RateLimitType.REQUEST_WEIGHT, 1) \
            .requires_auth(True) \
            .with_query_params(
        ...
        if auto_restake is not None:
            request.with_query_params(autoRestake=str(auto_restake).lower())  # Convert boolean to lowercase string
    ...
    def unstake(self, staking_asset: str, amount: Union[str, float]) -> Optional[StakingUnstakeResult]:
        """
        ...
        """
        response = self.request("POST", "/sapi/v1/staking/unstake", RateLimitType.REQUEST_WEIGHT, 1) \
            .requires_auth(True) \
            .with_query_params(
                stakingAsset=staking_asset,
                amount=str(amount)  # Ensure amount is a string
    ...
    def get_staking_balance(self, asset: Optional[str] = None) -> Optional[StakingBalanceResponse]:
        """
        ...
        """
        request = self.request("GET", "/sapi/v1/staking/stakingBalance", RateLimitType.REQUEST_WEIGHT, 1) \
            .requires_auth(True)
    ...
    def get_staking_history(self, asset: Optional[str] = None,
                          start_time: Optional[int] = None,
                          end_time: Optional[int] = None,
                          page: Optional[int] = None,
                          limit: Optional[int] = None) -> List[StakingHistoryItem]:
        """
        ...
        """
        request = self.request("GET", "/sapi/v1/staking/history", RateLimitType.REQUEST_WEIGHT, 1) \
            .requires_auth(True)
    ...
    def get_staking_rewards_history(self, asset: Optional[str] = None,
                                  start_time: Optional[int] = None,
                                  end_time: Optional[int] = None,
                                  page: Optional[int] = None,
                                  limit: Optional[int] = None) -> Optional[StakingRewardsResponse]:
        """
        ...
        """
        request = self.request("GET", "/sapi/v1/staking/stakingRewardsHistory", RateLimitType.REQUEST_WEIGHT, 1) \
            .requires_auth(True)
