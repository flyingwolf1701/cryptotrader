...
class WalletOperations:
    ...
    def get_asset_details(self, recv_window: Optional[int] = None) -> List[AssetDetail]:
        ...
        """
        request = self.request("GET", "/sapi/v1/capital/config/getall", RateLimitType.REQUEST_WEIGHT, 1) \
            .requires_auth(True)
        ...
        if response:
            for asset_data in response:
                asset_details.append(AssetDetail.from_api_response(asset_data))
        
        return asset_details
    
    def withdraw_fiat(self, payment_method: str, payment_account: str, amount: Union[str, float],
                    fiat_currency: Optional[str] = None,
                    recv_window: Optional[int] = None) -> Optional[FiatWithdrawResponse]:
        """
        ...
        """
        request = self.request("POST", "/sapi/v1/fiatpayment/withdraw/apply", RateLimitType.REQUEST_WEIGHT, 1) \
            .requires_auth(True) \
            .with_query_params(
    ...
    def withdraw_crypto(self, coin: str, network: str, address: str, amount: Union[str, float],
                      withdraw_order_id: Optional[str] = None,
                      address_tag: Optional[str] = None,
                      recv_window: Optional[int] = None) -> Optional[CryptoWithdrawResponse]:
        """
        ...
        """
        request = self.request("POST", "/sapi/v1/capital/withdraw/apply", RateLimitType.REQUEST_WEIGHT, 1) \
            .requires_auth(True) \
            .with_query_params(
                coin=coin,
                network=network,
    ...
    def get_crypto_withdraw_history(self, coin: Optional[str] = None, 
                                  withdraw_order_id: Optional[str] = None,
                                  ...
                                  recv_window: Optional[int] = None) -> List[WithdrawHistoryItem]:
        """
        ...
        """
        request = self.request("GET", "/sapi/v1/capital/withdraw/history", RateLimitType.REQUEST_WEIGHT, 1) \
            .requires_auth(True)
        ...
        if limit:
            request.with_query_params(limit=min(limit, 1000))  # Ensure limit doesn't exceed API max
    ...
    def get_fiat_withdraw_history(self, fiat_currency: Optional[str] = None,
                               ...
                               start_time: Optional[int] = None,
                               end_time: Optional[int] = None,
                               recv_window: Optional[int] = None) -> Optional[FiatWithdrawHistory]:
        """
        ...
        """
        request = self.request("GET", "/sapi/v1/fiatpayment/query/withdraw/history", RateLimitType.REQUEST_WEIGHT, 1) \
            .requires_auth(True)
    ...
    def get_deposit_address(self, coin: str, network: Optional[str] = None,
                          recv_window: Optional[int] = None) -> Optional[DepositAddress]:
        """
        ...
        """
        request = self.request("GET", "/sapi/v1/capital/deposit/address", RateLimitType.REQUEST_WEIGHT, 1) \
            .requires_auth(True) \
    ...
    def get_crypto_deposit_history(self, coin: Optional[str] = None,
                                status: Optional[int] = None,
                                start_time: Optional[int] = None,
                                end_time: Optional[int] = None,
                                offset: Optional[int] = None,
                                limit: Optional[int] = None,
                                recv_window: Optional[int] = None) -> List[DepositHistoryItem]:
        """
        ...
        """
        request = self.request("GET", "/sapi/v1/capital/deposit/hisrec", RateLimitType.REQUEST_WEIGHT, 1) \
            .requires_auth(True)
    ...
    def get_fiat_deposit_history(self, fiat_currency: Optional[str] = None,
                             order_id: Optional[str] = None,
                             offset: Optional[int] = None,
                             payment_channel: Optional[str] = None,
                             payment_method: Optional[str] = None,
                             start_time: Optional[int] = None,
                             end_time: Optional[int] = None,
                             recv_window: Optional[int] = None) -> Optional[FiatDepositHistory]:
        """
        ...
        """
        request = self.request("GET", "/sapi/v1/fiatpayment/query/deposit/history", RateLimitType.REQUEST_WEIGHT, 1) \
            .requires_auth(True)
    ...
    def get_subaccount_deposit_address(self, email: str, coin: str, 
                                     network: Optional[str] = None) -> Optional[DepositAddress]:
        """
        ...
        Returns:
            DepositAddress object with the address details, or None if the request failed
        """
        request = self.request("GET", "/sapi/v1/capital/sub-account/deposit/address", RateLimitType.REQUEST_WEIGHT, 1) \
            .requires_auth(True) \
            .with_query_params(
                email=email,
                coin=coin
    ...
    def get_subaccount_deposit_history(self, email: str, coin: Optional[str] = None,
                                     status: Optional[int] = None,
                                     start_time: Optional[int] = None,
                                     end_time: Optional[int] = None,
                                     limit: Optional[int] = None,
                                     offset: Optional[int] = None) -> List[DepositHistoryItem]:
        """
        ...
        Returns:
            List of DepositHistoryItem objects
        """
        request = self.request("GET", "/sapi/v1/capital/sub-account/deposit/history", RateLimitType.REQUEST_WEIGHT, 1) \
            .requires_auth(True) \
