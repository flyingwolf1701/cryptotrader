...
from cryptotrader.services.binance.models.otc_models import (
    OtcCoinPair, OtcQuote, OtcOrderResponse, OtcOrderDetail,
    OtcOrdersResponse, OcbsOrdersResponse
)
...
class OtcOperations:
    ...
    def get_coin_pairs(self, from_coin: Optional[str] = None, 
                      to_coin: Optional[str] = None) -> List[OtcCoinPair]:
        """
        ...
        """
        request = self.request("GET", "/sapi/v1/otc/coinPairs", RateLimitType.REQUEST_WEIGHT, 1) \
            .requires_auth(True)
        
        if from_coin:
            request.with_query_params(fromCoin=from_coin)
        if to_coin:
            request.with_query_params(toCoin=to_coin)
    ...
    def request_quote(self, from_coin: str, to_coin: str, 
                    request_coin: str, request_amount: Union[str, float]) -> Optional[OtcQuote]:
        """
        ...
        """
        response = self.request("POST", "/sapi/v1/otc/quotes", RateLimitType.REQUEST_WEIGHT, 1) \
            .requires_auth(True) \
            .with_query_params(
                fromCoin=from_coin,
                toCoin=to_coin,
    ...
    def place_order(self, quote_id: str) -> Optional[OtcOrderResponse]:
        ...
        """
        response = self.request("POST", "/sapi/v1/otc/orders", RateLimitType.REQUEST_WEIGHT, 1) \
            .requires_auth(True) \
            .with_query_params(quoteId=quote_id) \
            .execute()
    ...
    def get_order(self, order_id: str) -> Optional[OtcOrderDetail]:
        """
        ...
        """
        response = self.request("GET", f"/sapi/v1/otc/orders/{order_id}", RateLimitType.REQUEST_WEIGHT, 1) \
            .requires_auth(True) \
            .execute()
    ...
    def get_orders(self, order_id: Optional[str] = None, 
                 from_coin: Optional[str] = None, 
                 to_coin: Optional[str] = None,
                 start_time: Optional[int] = None,
                 end_time: Optional[int] = None,
                 page: Optional[int] = None,
                 limit: Optional[int] = None) -> Optional[OtcOrdersResponse]:
        """
        ...
        """
        request = self.request("GET", "/sapi/v1/otc/orders", RateLimitType.REQUEST_WEIGHT, 1) \
            .requires_auth(True)
        ...
        if limit:
            request.with_query_params(limit=min(limit, 100))  # Ensure limit doesn't exceed API max
    ...
    def get_ocbs_orders(self, order_id: Optional[str] = None,
                      start_time: Optional[int] = None,
                      end_time: Optional[int] = None,
                      page: Optional[int] = None,
                      limit: Optional[int] = None) -> Optional[OcbsOrdersResponse]:
        """
        ...
        """
        request = self.request("GET", "/sapi/v1/ocbs/orders", RateLimitType.REQUEST_WEIGHT, 1) \
            .requires_auth(True)
