...
from cryptotrader.services.binance.models.order_models import OcoOrderResponse
...
async def get_oco_history(
    ...
    msg_id = await connection.send(
        method="allOrderLists", params=params, security_type=SecurityType.USER_DATA
    )
...
async def process_oco_history_response(
    response: Dict[str, Any],
) -> Optional[List[OcoOrderResponse]]:
    """
