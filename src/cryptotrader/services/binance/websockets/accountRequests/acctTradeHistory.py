...
from cryptotrader.services.binance.models.order_models import OrderTrade

logger = get_logger(__name__)


async def getTradeHistoryWS(
    ...
    msg_id = await connection.send(
        method="myTrades", params=params, security_type=SecurityType.USER_DATA
    )
...
async def processTradeHistoryResponse(
    response: Dict[str, Any],
) -> Optional[List[OrderTrade]]:
    """
