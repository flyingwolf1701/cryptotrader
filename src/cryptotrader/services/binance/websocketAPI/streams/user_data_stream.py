...
from cryptotrader.services.binance.websocketAPI.websocket_stream_manager import BinanceStreamManager
...
class UserDataStream:
    ...
    async def start(self) -> bool:
        ...
        self.is_active = True
        logger.info(f"User data stream started with listenKey: {self.listen_key[:10]}...")
        return True
