...
async def cancel_order(
    ...
    Args:
        ...
        new_client_order_id: New client order ID for the canceled order (optional)
...
async def process_cancel_order_response(response: Dict[str, Any]) -> Optional[OrderStatusResponse]:
    """
