...
from services.binance.models import (
    # Market models
    PriceData, Candle, Trade, AggTrade, OrderBook, TickerPrice, 
    AvgPrice, PriceStats, PriceStatsMini, RollingWindowStats, RollingWindowStatsMini,
    
    # Order models
    OrderRequest, OrderStatusResponse, OrderResponseFull, OrderResponseResult, 
    OrderResponseAck, CancelReplaceResponse, OrderTrade, PreventedMatch, 
    RateLimitInfo, OcoOrderResponse,
    
    # Wallet models
    AssetDetail, FiatWithdrawResponse, CryptoWithdrawResponse, WithdrawHistoryItem,
    FiatWithdrawHistory, DepositAddress, DepositHistoryItem, FiatDepositHistory,
...
class BinanceRestUnifiedClient:
    ...
    ) -> Union[Union[PriceStats, PriceStatsMini], List[Union[PriceStats, PriceStatsMini]], None]:
        """
    ...
    def get_crypto_withdraw_history(
        ...
        return self.wallet.get_crypto_withdraw_history(
            coin, withdraw_order_id, status, start_time, end_time, offset, limit, recv_window
        )
